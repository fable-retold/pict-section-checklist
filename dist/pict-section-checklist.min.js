...
/**
       ...
       * @license MIT
       */
const n=t("./views/PictView-Checklist.js"),o=t("./providers/ChecklistProvider-Base.js"),a=t("./ChecklistModel.js");e.exports=n,e.exports.default_configuration=n.default_configuration,e.exports.ChecklistDataProvider=o.ChecklistDataProvider,e.exports.InMemoryChecklistProvider=o.InMemoryChecklistProvider,e.exports.normalizeContext=o.normalizeContext,e.exports.Model=a},{"./ChecklistModel.js":15,"./providers/ChecklistProvider-Base.js":17,"./views/PictView-Checklist.js":18}],17:[function(t,e,i){const n="Checklist";function o(t){let e=t||{};return{OwnerType:String(e.OwnerType||""),IDOwner:String(e.IDOwner||"")}}function a(t,e){let i=-1,n=Object.keys(t);for(let o=0;o<n.length;o++){let a=t[n[o]];String(a.ListKey)===String(e)&&"number"==typeof a.Sort&&a.Sort>i&&(i=a.Sort)}return i+1}class s{constructor(t){this.options=t||{},this._now="function"==typeof this.options.Now?this.options.Now:function(){return Date.now()};let e=0;this._key="function"==typeof this.options.KeyGenerator?this.options.KeyGenerator:()=>(e++,"chk_"+this._now().toString(36)+"_"+e.toString(36)+"_"+Math.floor(2147483647*Math.random()).toString(36))}getList(t){return Promise.reject(new Error("ChecklistDataProvider.getList not implemented"))}updateList(t,e){return Promise.reject(new Error("ChecklistDataProvider.updateList not implemented"))}listItems(t){return Promise.reject(new Error("ChecklistDataProvider.listItems not implemented"))}createItem(t){return Promise.reject(new Error("ChecklistDataProvider.createItem not implemented"))}updateItem(t,e){return Promise.reject(new Error("ChecklistDataProvider.updateItem not implemented"))}deleteItem(t){return Promise.reject(new Error("ChecklistDataProvider.deleteItem not implemented"))}loadChecklist(t){return this.getList(t).then(t=>t?this.listItems(t.Key).then(e=>({List:t,Items:e||[]})):{List:null,Items:[]})}}e.exports={ChecklistDataProvider:s,InMemoryChecklistProvider:class extends s{constructor(t){super(t);let e=this.options&&this.options.Store?this.options.Store:{};e.Lists||(e.Lists={}),e.Items||(e.Items={}),this.store=e,this._title=this.options.Title||n}_clone(t){return null==t?t:JSON.parse(JSON.stringify(t))}getList(t){let e=o(t),i=Object.keys(this.store.Lists).map(t=>this.store.Lists[t]).find(t=>String(t.OwnerType)===e.OwnerType&&String(t.IDOwner)===e.IDOwner);if(i)return Promise.resolve(this._clone(i));let n=this._now(),a={Key:this._key(),OwnerType:e.OwnerType,IDOwner:e.IDOwner,Title:this._title,CreatedAt:n,UpdatedAt:n};return this.store.Lists[a.Key]=a,Promise.resolve(this._clone(a))}updateList(t,e){let i=this.store.Lists[t];return i?(e&&Object.prototype.hasOwnProperty.call(e,"Title")&&(i.Title=String(e.Title)),i.UpdatedAt=this._now(),Promise.resolve(this._clone(i))):Promise.reject(new Error("updateList: no list "+t))}listItems(t){let e=Object.keys(this.store.Items).map(t=>this.store.Items[t]).filter(e=>String(e.ListKey)===String(t)&&!e.Deleted).sort((t,e)=>t.Sort-e.Sort);return Promise.resolve(this._clone(e))}createItem(t){let e=t||{};if(!e.ListKey||!this.store.Lists[e.ListKey])return Promise.reject(new Error("createItem requires a ListKey of an existing list"));let i=this._now(),n={Key:e.Key||this._key(),ListKey:e.ListKey,ParentKey:null!=e.ParentKey&&""!==e.ParentKey?String(e.ParentKey):null,Title:null!=e.Title?String(e.Title):"",Done:!!e.Done,Sort:"number"==typeof e.Sort?e.Sort:a(this.store.Items,e.ListKey),Notes:e.Notes?String(e.Notes):"",Collapsed:!!e.Collapsed,CreatedAt:i,UpdatedAt:i,Deleted:!1};return this.store.Items[n.Key]=n,Promise.resolve(this._clone(n))}updateItem(t,e){let i=this.store.Items[t];if(!i||i.Deleted)return Promise.reject(new Error("updateItem: no item "+t));let n=e||{},o=["Title","Done","Sort","ParentKey","Notes","Collapsed"];for(let t=0;t<o.length;t++){let e=o[t];Object.prototype.hasOwnProperty.call(n,e)&&("ParentKey"===e?i.ParentKey=null!=n.ParentKey&&""!==n.ParentKey?String(n.ParentKey):null:i[e]="Title"===e||"Notes"===e?String(n[e]):"Done"===e||"Collapsed"===e?!!n[e]:n[e])}return i.UpdatedAt=this._now(),Promise.resolve(this._clone(i))}deleteItem(t){let e={},i=t=>{e[t]=!0;let n=Object.keys(this.store.Items);for(let o=0;o<n.length;o++){let a=this.store.Items[n[o]];null==a.ParentKey||String(a.ParentKey)!==String(t)||e[a.Key]||i(a.Key)}};return this.store.Items[t]&&i(t),Object.keys(e).forEach(t=>{delete this.store.Items[t]}),Promise.resolve()}},normalizeContext:o,DEFAULT_TITLE:n}},{}],18:[function(t,e,i){
/**
       * PictView-Checklist
       * ------------------
