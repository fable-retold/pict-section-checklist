...
(function (f) {
  ...
  return function () {
    ...
    3: [function (require, module, exports) {
       ...
       */
      var PictModalConfirm = /*#__PURE__*/function () {
        function PictModalConfirm(pModal) {
          _classCallCheck(this, PictModalConfirm);
          this._modal = pModal;
        }
        ...
        return _createClass(PictModalConfirm, [{
          key: "confirm",
          value: function confirm(pMessage, pOptions) {
            var _this = this;
            var tmpOptions = Object.assign({}, this._modal.options.DefaultConfirmOptions, pOptions);
            return new Promise(function (fResolve) {
              var tmpDialog = _this._buildDialog(tmpOptions.title, pMessage, fResolve, tmpOptions);
              _this._showDialog(tmpDialog, fResolve);
            });
          }
          ...
          key: "doubleConfirm",
          value: function doubleConfirm(pMessage, pOptions) {
            var _this2 = this;
            var tmpOptions = Object.assign({}, this._modal.options.DefaultDoubleConfirmOptions, pOptions);
            return new Promise(function (fResolve) {
              var tmpDialog = _this2._buildDoubleConfirmDialog(tmpOptions.title, pMessage, fResolve, tmpOptions);
              _this2._showDialog(tmpDialog, fResolve);
            });
          }
          ...
          key: "_buildDialog",
          value: function _buildDialog(pTitle, pMessage, fResolve, pOptions) {
            var _this3 = this;
            var tmpId = this._modal._nextId();
            var tmpBtnStyle = pOptions.dangerous ? 'danger' : 'primary';
            var tmpDialog = document.createElement('div');
            ...
            var tmpCloseBtn = tmpDialog.querySelector('.pict-modal-dialog-close');
            var tmpCancelBtn = tmpDialog.querySelector('[data-action="cancel"]');
            var tmpConfirmBtn = tmpDialog.querySelector('[data-action="confirm"]');
            var tmpDismiss = function tmpDismiss(pResult) {
              _this3._dismissDialog(tmpDialog, pResult, fResolve);
            };
            tmpCloseBtn.addEventListener('click', function () {
              tmpDismiss(false);
            });
            tmpCancelBtn.addEventListener('click', function () {
              tmpDismiss(false);
            });
            tmpConfirmBtn.addEventListener('click', function () {
              tmpDismiss(true);
            });
          ...
          key: "_buildDoubleConfirmDialog",
          value: function _buildDoubleConfirmDialog(pTitle, pMessage, fResolve, pOptions) {
            var _this4 = this;
            var tmpId = this._modal._nextId();
            var tmpHasPhrase = typeof pOptions.confirmPhrase === 'string' && pOptions.confirmPhrase.length > 0;
            var tmpDialog = document.createElement('div');
            tmpDialog.className = 'pict-modal-dialog';
            if (pOptions.unbounded) {
              tmpDialog.className += ' pict-modal-dialog--unbounded';
            ...
            tmpDialog.setAttribute('aria-modal', 'true');
            tmpDialog.style.width = '420px';
            var tmpBodyContent = '<p>' + this._escapeHTML(pMessage) + '</p>';
            if (tmpHasPhrase) {
              var tmpPromptText = pOptions.phrasePrompt.replace('{phrase}', pOptions.confirmPhrase);
            ...
            var tmpConfirmBtn = tmpDialog.querySelector('[data-action="confirm"]');
            var tmpDismiss = function tmpDismiss(pResult) {
              _this4._dismissDialog(tmpDialog, pResult, fResolve);
            };
            tmpCloseBtn.addEventListener('click', function () {
              tmpDismiss(false);
            });
            ...
            if (tmpHasPhrase) {
              ...
              var tmpInput = tmpDialog.querySelector('.pict-modal-confirm-input');
              ...
              var tmpClickCount = 0;
              var tmpOriginalLabel = pOptions.confirmLabel;
          ...
          key: "_showDialog",
          value: function _showDialog(pDialog, fResolve) {
            var tmpModalEntry = {
              element: pDialog,
            ...
            // Show overlay
            var tmpOverlayClickHandler = null;
            if (this._modal.options.OverlayClickDismisses) {
              tmpOverlayClickHandler = function tmpOverlayClickHandler() {
            ...
            // Keyboard handler
            pDialog._keyHandler = function (pEvent) {
          ...
          key: "_dismissDialog",
          value: function _dismissDialog(pDialog, pResult, fResolve) {
            ...
            this._modal._activeModals = this._modal._activeModals.filter(function (pEntry) {
            ...
            if (this._modal._activeModals.length > 0) {
              var tmpTopModal = this._modal._activeModals[this._modal._activeModals.length - 1];
    ...
    4: [function (require, module, exports) {
       ...
       * `null` on dismiss.
       */
      var PictModalDropdown = /*#__PURE__*/function () {
        function PictModalDropdown(pModal) {
          _classCallCheck(this, PictModalDropdown);
          this._modal = pModal;
        ...
        return _createClass(PictModalDropdown, [{
          key: "dropdown",
          value: function dropdown(pAnchor, pOptions) {
            var _this5 = this;
            ...
            var tmpAnchorEl = this._resolveAnchor(pAnchor);
            var tmpAnchorRect = this._anchorRect(pAnchor, tmpAnchorEl);
            if (!tmpAnchorRect) {
            ...
            this.dismissAll();
            var tmpItems = Array.isArray(tmpOptions.items) ? tmpOptions.items : [];
            var tmpResolveOuter;
            var tmpPromise = new Promise(function (fResolve) {
              tmpResolveOuter = fResolve;
            });
            var tmpMenu = this._buildMenu(tmpItems, tmpOptions);
            ...
            var tmpDismiss = function tmpDismiss(pResult) {
              ...
              if (_this5._activeMenu && _this5._activeMenu.element === tmpMenu) {
                _this5._activeMenu = null;
              }
            ...
            var tmpItemEls = tmpMenu.querySelectorAll('[data-pict-modal-dropdown-item]');
            var _loop = function _loop() {
              var tmpEl = tmpItemEls[i];
              tmpEl.addEventListener('click', function (pEvent) {
                if (tmpEl.hasAttribute('data-disabled')) {
                  return;
                }
                pEvent.stopPropagation();
                var tmpIdx = parseInt(tmpEl.getAttribute('data-index'), 10);
                var tmpItem = tmpItems[tmpIdx];
                var tmpHash = tmpEl.getAttribute('data-hash');
            ...
            for (var i = 0; i < tmpItemEls.length; i++) {
              _loop();
            }
            ...
            var tmpOutsideHandler = function tmpOutsideHandler(pEvent) {
            ...
            var tmpKeyHandler = function tmpKeyHandler(pEvent) {
              if (pEvent.key === 'Escape') {
                pEvent.stopPropagation();
                tmpDismiss(null);
                return;
              ...
              if (pEvent.key === 'ArrowDown' || pEvent.key === 'ArrowUp') {
                ...
                _this5._focusNeighbor(tmpMenu, pEvent.key === 'ArrowDown' ? 1 : -1);
              } else if (pEvent.key === 'Enter' || pEvent.key === ' ') {
                var tmpFocused = document.activeElement;
            ...
            // off the anchor.
            var tmpRepositionHandler = function tmpRepositionHandler() {
              var tmpRect = _this5._anchorRect(pAnchor, tmpAnchorEl);
              if (tmpRect) {
                _this5._positionMenu(tmpMenu, tmpRect, tmpOptions);
              }
            };
            ...
            setTimeout(function () {
              _this5._focusFirstEnabled(tmpMenu);
            }, 0);
            this._activeMenu = {
              element: tmpMenu,
              anchor: tmpAnchorEl,
          ...
          value: function dismissAll() {
            if (this._activeMenu) {
              var tmpDismiss = this._activeMenu.dismiss;
              this._activeMenu = null;
              tmpDismiss(null);
            }
          }
          ...
          key: "_resolveAnchor",
          value: function _resolveAnchor(pAnchor) {
            if (!pAnchor) {
              return null;
            }
          ...
          key: "_anchorRect",
          value: function _anchorRect(pAnchor, pAnchorEl) {
            if (pAnchorEl && typeof pAnchorEl.getBoundingClientRect === 'function') {
              return pAnchorEl.getBoundingClientRect();
            }
            if (pAnchor && _typeof(pAnchor) === 'object' && typeof pAnchor.left === 'number' && typeof pAnchor.top === 'number') {
              return {
                left: pAnchor.left,
                top: pAnchor.top,
          ...
          key: "_buildMenu",
          value: function _buildMenu(pItems, pOptions) {
            var tmpId = this._modal._nextId();
            var tmpMenu = document.createElement('div');
            ...
            for (var i = 0; i < pItems.length; i++) {
              ...
              var tmpCls = 'pict-modal-dropdown-item';
              if (tmpItem.Style) {
              ...
              var tmpAttrs = '' + ' data-pict-modal-dropdown-item' + ' data-index="' + i + '"' + ' data-hash="' + this._escapeHTML(tmpItem.Hash || '') + '"' + ' role="menuitem"' + ' tabindex="-1"';
              if (tmpItem.Disabled) {
              ...
              var tmpIcon = tmpItem.Icon ? '<span class="pict-modal-dropdown-item-icon">' + tmpItem.Icon + '</span>' : '';
              var tmpHint = tmpItem.Hint ? '<span class="pict-modal-dropdown-item-hint">' + this._escapeHTML(tmpItem.Hint) + '</span>' : '';
          ...
          key: "_positionMenu",
          value: function _positionMenu(pMenu, pAnchorRect, pOptions) {
            // Apply min-width before measuring so the menu's natural size accounts
            // for the constraint.
            var tmpMinWidth = pOptions.minWidth || (pAnchorRect.width >= 80 ? Math.ceil(pAnchorRect.width) + 'px' : '160px');
            pMenu.style.minWidth = tmpMinWidth;

            // Measure after attaching.
            var tmpMenuRect = pMenu.getBoundingClientRect();
            var tmpVw = window.innerWidth || document.documentElement.clientWidth;
            var tmpVh = window.innerHeight || document.documentElement.clientHeight;
            var tmpGap = 4; // breathing room between anchor and menu

            // Vertical: prefer below; flip above when not enough room and there's
            // more above. 'below'/'above' overrides force the side.
            var tmpRoomBelow = tmpVh - pAnchorRect.bottom - tmpGap;
            var tmpRoomAbove = pAnchorRect.top - tmpGap;
            var tmpPlaceAbove;
            ...
            var tmpCap = Math.max(80, (tmpPlaceAbove ? tmpRoomAbove : tmpRoomBelow) - 8);
          ...
          key: "_focusFirstEnabled",
          value: function _focusFirstEnabled(pMenu) {
            var tmpItems = pMenu.querySelectorAll('[data-pict-modal-dropdown-item]:not([data-disabled])');
            if (tmpItems.length) {
              tmpItems[0].focus();
            }
          }
          ...
          key: "_focusNeighbor",
          value: function _focusNeighbor(pMenu, pDirection) {
            var tmpItems = Array.prototype.slice.call(pMenu.querySelectorAll('[data-pict-modal-dropdown-item]:not([data-disabled])'));
            if (!tmpItems.length) {
              return;
            }
            var tmpActive = document.activeElement;
            var tmpIdx = tmpItems.indexOf(tmpActive);
            var tmpNext = tmpIdx === -1 ? pDirection > 0 ? 0 : tmpItems.length - 1 : (tmpIdx + pDirection + tmpItems.length) % tmpItems.length;
    ...
    5: [function (require, module, exports) {
       ...
       */
      var PictModalOverlay = /*#__PURE__*/function () {
        function PictModalOverlay(pModal) {
          _classCallCheck(this, PictModalOverlay);
          this._modal = pModal;
          this._element = null;
          this._refCount = 0;
        }
         ...
         */
        return _createClass(PictModalOverlay, [{
          key: "show",
          value: function show(fOnClick) {
            var _this6 = this;
            this._refCount++;
            if (!this._element) {
            ...
            if (fOnClick) {
              ...
              this._element.onclick = function (pEvent) {
                if (pEvent.target === _this6._element && _this6._currentClickHandler) {
                  _this6._currentClickHandler();
                }
              };
            }
          }
          ...
          key: "updateClickHandler",
          value: function updateClickHandler(fOnClick) {
    ...
    6: [function (require, module, exports) {
       ...
       *   handle.destroy();
       */
      var PictModalPanel = /*#__PURE__*/function () {
        function PictModalPanel(pModal) {
          _classCallCheck(this, PictModalPanel);
          this._modal = pModal;
          this._panels = [];
        }
         ...
         */
        return _createClass(PictModalPanel, [{
          key: "create",
          value: function create(pTargetSelector, pOptions) {
            var _this7 = this;
            var tmpDefaults = this._modal && this._modal.options && this._modal.options.DefaultPanelOptions || {};
            var tmpOptions = Object.assign({}, {
              position: 'right',
              width: 340,
              minWidth: 200,
            ...
            var tmpTarget = document.querySelector(pTargetSelector);
            if (!tmpTarget) return this._nullHandle();
            var tmpId = this._modal._nextId();
            var tmpIsRight = tmpOptions.position === 'right';
            var tmpIsCollapsed = false;
            var tmpCurrentWidth = tmpOptions.width;
            var tmpDestroyed = false;

            // Restore persisted state
            if (tmpOptions.persist && tmpOptions.persistKey) {
              try {
                var tmpStored = localStorage.getItem('pict-panel-' + tmpOptions.persistKey);
                if (tmpStored) {
                  var tmpParsed = JSON.parse(tmpStored);
            ...
            var tmpPictHandle = typeof window !== 'undefined' && window.pict ? window.pict : null;
            var tmpIcon = function tmpIcon(pName) {
              return tmpPictHandle && typeof tmpPictHandle.icon === 'function' ? tmpPictHandle.icon(pName) : '';
            };
            var tmpUpdateChevron = function tmpUpdateChevron() {
              if (!tmpTab) return;
              var tmpChevronRight = tmpIcon('ChevronRight');
              var tmpChevronLeft = tmpIcon('ChevronLeft');
              if (tmpIsRight) {
            ...
            // ── Persist helper ──────────────────────────────────
            var tmpPersist = function tmpPersist() {
            ...
            // ── Collapse / expand ───────────────────────────────
            var tmpCollapse = function tmpCollapse() {
            ...
            var tmpExpand = function tmpExpand() {
              if (!tmpIsCollapsed || tmpDestroyed) return;
            ...
            var tmpToggle = function tmpToggle() {
              if (tmpIsCollapsed) tmpExpand();else tmpCollapse();
            };
            var tmpSetWidth = function tmpSetWidth(pWidth) {
              if (tmpDestroyed) return;
              var tmpWidth = Math.max(tmpOptions.minWidth, Math.min(tmpOptions.maxWidth, pWidth));
            ...
            // ── Tab click ───────────────────────────────────────
            if (tmpTab) {
              tmpTab.addEventListener('click', function (pEvent) {
                pEvent.stopPropagation();
                tmpToggle();
              });
            }
            ...
            // ── Resize drag ─────────────────────────────────────
            var tmpOnMouseDown = function tmpOnMouseDown(pEvent) {
              if (tmpIsCollapsed) return;
              pEvent.preventDefault();
              var tmpStartX = pEvent.clientX;
              var tmpStartWidth = tmpTarget.offsetWidth;
              tmpResize.classList.add('dragging');
              tmpTarget.style.transition = 'none';
              document.body.style.userSelect = 'none';
              document.body.style.cursor = 'col-resize';
              var tmpOnMouseMove = function tmpOnMouseMove(pMoveEvent) {
                var tmpDelta = tmpIsRight ? tmpStartX - pMoveEvent.clientX : pMoveEvent.clientX - tmpStartX;
                var tmpNewWidth = Math.max(tmpOptions.minWidth, Math.min(tmpOptions.maxWidth, tmpStartWidth + tmpDelta));
                tmpTarget.style.width = tmpNewWidth + 'px';
              };
              var _tmpOnMouseUp = function tmpOnMouseUp(pUpEvent) {
                document.removeEventListener('mousemove', tmpOnMouseMove);
                document.removeEventListener('mouseup', _tmpOnMouseUp);
              ...
              document.addEventListener('mouseup', _tmpOnMouseUp);
            };
            ...
            // ── Destroy ─────────────────────────────────────────
            var tmpDestroy = function tmpDestroy() {
              if (tmpDestroyed) return;
              tmpDestroyed = true;
              ...
              tmpTarget.style.transition = '';
              var tmpIdx = _this7._panels.indexOf(tmpHandle);
              if (tmpIdx >= 0) _this7._panels.splice(tmpIdx, 1);
            };
          ...
          value: function destroyAll() {
            var tmpPanels = this._panels.slice();
    ...
    7: [function (require, module, exports) {
      ...
      var STORAGE_PREFIX = 'pict-modal-shell:';
      var SCHEMA_VERSION = 1;
      var DEFAULT_COLLAPSED_SIZE = 24;
      var DEFAULT_SIZE_SIDE = 240;
      var DEFAULT_SIZE_TOPBOTTOM = 60;
      var PictModalShell = /*#__PURE__*/function () {
        function PictModalShell(pModalSection, pViewportEl, pOptions) {
          var _this8 = this;
          _classCallCheck(this, PictModalShell);
          ...
          _defineProperty(this, "_onDragMove", function (pEvent) {
            if (!_this8._activeDrag) return;
            var tmpD = _this8._activeDrag;
            var tmpCoord = tmpD.Axis === 'x' ? pEvent.clientX : pEvent.clientY;
            var tmpDelta = (tmpCoord - tmpD.StartCoord) * tmpD.Direction;
          ...
          _defineProperty(this, "_onDragEnd", function () {
            if (!_this8._activeDrag) return;
            var tmpD = _this8._activeDrag;
            ...
            document.removeEventListener('pointermove', _this8._onDragMove);
            document.removeEventListener('pointerup', _this8._onDragEnd);
            // Persist final size.
            tmpD.Panel._persist();
            _this8._activeDrag = null;
          });
        ...
        //  Public API
        // ────────────────────────────────────────────────────────────────
        return _createClass(PictModalShell, [{
          key: "addPanel",
          value: function addPanel(pConfig) {
            var tmpPanel = new ShellPanel(this, pConfig || {});
          ...
          key: "openPanel",
          value: function openPanel(pHash) {
            var tmpPanel = this._panelsByHash[pHash];
            if (tmpPanel) {
              tmpPanel.popup();
            }
          ...
          key: "center",
          value: function center(pOptions) {
            pOptions = pOptions || {};
            if (pOptions.ContentDestinationId) {
              ...
              var tmpFirstBottomScoped = null;
              var tmpChildren = this._centerEl.children;
              for (var i = 0; i < tmpChildren.length; i++) {
                var tmpCandidate = tmpChildren[i];
          ...
          key: "_resolvePersistenceKey",
          value: function _resolvePersistenceKey(pUserKey) {
          ...
          value: function _loadState() {
            ...
            try {
              var tmpStore = typeof window !== 'undefined' ? window.localStorage : null;
              if (!tmpStore) return null;
              var tmpRaw = tmpStore.getItem(this._persistenceKey);
              if (!tmpRaw) return null;
              var tmpParsed = JSON.parse(tmpRaw);
              if (!tmpParsed || tmpParsed.Version !== SCHEMA_VERSION) return null;
              return tmpParsed.Panels && _typeof(tmpParsed.Panels) === 'object' ? tmpParsed.Panels : {};
            } catch (pErr) {
              return null;
            }
          }
          ...
          key: "_loadPanelState",
          value: function _loadPanelState(pHash) {
            var tmpAll = this._loadState();
            if (!tmpAll) return null;
            return tmpAll[pHash] || null;
          }
        }, {
          key: "_savePanelState",
          value: function _savePanelState(pHash, pState) {
          ...
          key: "_mountPanel",
          value: function _mountPanel(pPanel) {
          ...
          key: "_attachDragStart",
          value: function _attachDragStart(pPanel, pEvent) {
            pEvent.preventDefault();
            var tmpAxis = pPanel.Side === 'top' || pPanel.Side === 'bottom' ? 'y' : 'x';
            this._activeDrag = {
              Panel: pPanel,
              Axis: tmpAxis,
          ...
          key: "_flushDrag",
          value: function _flushDrag() {
            var tmpD = this._activeDrag;
            if (!tmpD) return;
            tmpD.RAFId = 0;
            if (tmpD.PendingSize !== null) {
          ...
          key: "_detachDragHandlers",
          value: function _detachDragHandlers() {
      ...
      // ════════════════════════════════════════════════════════════════════
      var ShellPanel = /*#__PURE__*/function () {
        function ShellPanel(pShell, pConfig) {
          ...
          var tmpDefaultSize = this.Side === 'left' || this.Side === 'right' ? DEFAULT_SIZE_SIDE : DEFAULT_SIZE_TOPBOTTOM;
          ...
          if (this.PersistEnabled) {
            var tmpSaved = pShell._loadPanelState(this.Hash);
            if (tmpSaved) {
        ...
        // ───────────── public ─────────────
        return _createClass(ShellPanel, [{
          key: "getContentEl",
          value: function getContentEl() {
          ...
          value: function getContentView() {
            ...
            var tmpPict = this._shell._modal && this._shell._modal.pict;
          ...
          key: "destroy",
          value: function destroy(pSkipFromShell) {
            this._unwireResponsiveDrawer();
            if (this.El && this.El.parentNode) this.El.parentNode.removeChild(this.El);
            if (!pSkipFromShell) {
              var tmpIdx = this._shell._panels.indexOf(this);
          ...
          key: "_wireResponsiveDrawer",
          value: function _wireResponsiveDrawer() {
            ...
            this._mediaQueryHandler = function (pEvent) {
              var tmpNarrow = pEvent && typeof pEvent.matches === 'boolean' ? pEvent.matches : tmpSelf._mediaQuery.matches;
          ...
          key: "_unwireResponsiveDrawer",
          value: function _unwireResponsiveDrawer() {
          ...
          key: "_setDrawerMode",
          value: function _setDrawerMode(pDrawer) {
            ...
            var tmpCurrentlyDrawer = !!(this.El && this.El.classList.contains('pict-modal-shell-panel-drawer'));
            ...
            if (pDrawer) {
              ...
              var tmpStillNarrow = false;
              var tmpPanels = this._shell._panels || [];
              for (var i = 0; i < tmpPanels.length; i++) {
                var tmpP = tmpPanels[i];
          ...
          key: "_buildEl",
          value: function _buildEl(pConfig) {
            ...
            var tmpContentWrap = document.createElement('div');
            ...
            if (this.Mode === 'resizable') {
              ...
              this._resizeHandle.addEventListener('pointerdown', function (pEvent) {
                if (_tmpSelf.Collapsed) return;
                _tmpSelf._shell._attachDragStart(_tmpSelf, pEvent);
              });
          ...
          value: function _applySize() {
            var tmpEffective = this.Collapsed ? this.CollapsedSize : this.Size;
          ...
          key: "_applyCollapsedClass",
          value: function _applyCollapsedClass() {
          ...
          key: "_setCollapsed",
          value: function _setCollapsed(pBool) {
            if (this.Collapsed === !!pBool) return;
            var tmpWasCollapsed = this.Collapsed;
          ...
          key: "_fireHook",
          value: function _fireHook(pName, pArg) {
            var tmpFn = this._config[pName];
          ...
          key: "_renderContentView",
          value: function _renderContentView() {
            var tmpView = this.getContentView();
      ...
      // ════════════════════════════════════════════════════════════════════
      var PictModalShellManager = /*#__PURE__*/function () {
        function PictModalShellManager(pModalSection) {
          _classCallCheck(this, PictModalShellManager);
          this._modal = pModalSection;
        ...
        return _createClass(PictModalShellManager, [{
          key: "shell",
          value: function shell(pViewportSelectorOrEl, pOptions) {
            var tmpEl = typeof pViewportSelectorOrEl === 'string' ? document.querySelector(pViewportSelectorOrEl) : pViewportSelectorOrEl;
            if (!tmpEl) {
              throw new Error('Pict-Modal-Shell.shell: viewport not found for ' + pViewportSelectorOrEl);
            }
            var tmpExisting = this._shellsByViewport.get(tmpEl);
            if (tmpExisting) return tmpExisting;
            var tmpShell = new PictModalShell(this._modal, tmpEl, pOptions);
    ...
    8: [function (require, module, exports) {
       ...
       */
      var PictModalToast = /*#__PURE__*/function () {
        function PictModalToast(pModal) {
          _classCallCheck(this, PictModalToast);
          this._modal = pModal;
          this._containers = {};
        }
         ...
         */
        return _createClass(PictModalToast, [{
          key: "toast",
          value: function toast(pMessage, pOptions) {
            var _this9 = this;
            var tmpOptions = Object.assign({}, this._modal.options.DefaultToastOptions, pOptions);
            var tmpContainer = this._getContainer(tmpOptions.position);
            var tmpId = this._modal._nextId();
            var tmpToast = document.createElement('div');
            tmpToast.className = 'pict-modal-toast pict-modal-toast--' + tmpOptions.type;
            tmpToast.id = 'pict-modal-toast-' + tmpId;
            var tmpContent = '<span class="pict-modal-toast-message">' + this._escapeHTML(pMessage) + '</span>';
            ...
            // Create handle
            var tmpDismissed = false;
            var tmpTimeoutHandle = null;
            var tmpDismiss = function tmpDismiss() {
              if (tmpDismissed) {
                return;
              }
              tmpDismissed = true;
              ...
              _this9._modal._activeToasts = _this9._modal._activeToasts.filter(function (pEntry) {
              ...
              setTimeout(function () {
                ...
                _this9._cleanupContainer(tmpOptions.position);
              }, 220);
            };
            var tmpHandle = {
              dismiss: tmpDismiss
            ...
            // Wire dismiss button
            if (tmpOptions.dismissible) {
              var tmpDismissBtn = tmpToast.querySelector('.pict-modal-toast-dismiss');
              if (tmpDismissBtn) {
          ...
          key: "_getContainer",
          value: function _getContainer(pPosition) {
          ...
          value: function _cleanupContainer(pPosition) {
            var tmpContainer = this._containers[pPosition];
          ...
          key: "dismissAll",
          value: function dismissAll() {
            var tmpToasts = this._modal._activeToasts.slice();
            for (var i = 0; i < tmpToasts.length; i++) {
              tmpToasts[i].dismiss();
            }
          }
          ...
          value: function destroy() {
            this.dismissAll();
            var tmpPositions = Object.keys(this._containers);
            for (var i = 0; i < tmpPositions.length; i++) {
              var tmpContainer = this._containers[tmpPositions[i]];
    ...
    9: [function (require, module, exports) {
       ...
       */
      var PictModalTooltip = /*#__PURE__*/function () {
        function PictModalTooltip(pModal) {
          _classCallCheck(this, PictModalTooltip);
          this._modal = pModal;
        }
         ...
         */
        return _createClass(PictModalTooltip, [{
          key: "tooltip",
          value: function tooltip(pElement, pText, pOptions) {
            var tmpOptions = Object.assign({}, this._modal.options.DefaultTooltipOptions, pOptions);
          ...
          key: "richTooltip",
          value: function richTooltip(pElement, pHTMLContent, pOptions) {
            var tmpOptions = Object.assign({}, this._modal.options.DefaultTooltipOptions, pOptions);
          ...
          key: "_attachTooltip",
          value: function _attachTooltip(pElement, pContent, pIsHTML, pOptions) {
            var _this0 = this;
            var tmpTooltipElement = null;
            var tmpShowTimeout = null;
            var tmpHideTimeout = null;
            var tmpDestroyed = false;
            var tmpId = this._modal._nextId();
            var tmpShow = function tmpShow() {
              ...
              // Arrow
              var tmpArrow = document.createElement('div');
              ...
              // Position
              _this0._positionTooltip(tmpTooltipElement, pElement, pOptions.position);
              ...
              // Track
              _this0._modal._activeTooltips.push({
              ...
              if (pOptions.interactive && tmpTooltipElement) {
                tmpTooltipElement.addEventListener('mouseenter', function () {
                  if (tmpHideTimeout) {
                    clearTimeout(tmpHideTimeout);
                    tmpHideTimeout = null;
                  }
                });
                tmpTooltipElement.addEventListener('mouseleave', function () {
                  tmpHide();
                });
              }
            };
            var tmpHide = function tmpHide() {
              if (!tmpTooltipElement) {
                return;
              }
              tmpTooltipElement.classList.remove('pict-modal-visible');
              var tmpEl = tmpTooltipElement;
              ...
              _this0._modal._activeTooltips = _this0._modal._activeTooltips.filter(function (pEntry) {
            ...
            var tmpOnMouseEnter = function tmpOnMouseEnter() {
              if (tmpHideTimeout) {
                clearTimeout(tmpHideTimeout);
                tmpHideTimeout = null;
              }
            ...
            var tmpOnMouseLeave = function tmpOnMouseLeave() {
              if (tmpShowTimeout) {
            ...
            var tmpOnFocusIn = function tmpOnFocusIn() {
              tmpShowTimeout = setTimeout(tmpShow, pOptions.delay);
            };
            var tmpOnFocusOut = function tmpOnFocusOut() {
              if (tmpShowTimeout) {
                clearTimeout(tmpShowTimeout);
                tmpShowTimeout = null;
              }
          ...
          value: function _positionTooltip(pTooltip, pTarget, pPosition) {
            var tmpTargetRect = pTarget.getBoundingClientRect();
            var tmpTooltipRect = pTooltip.getBoundingClientRect();
            var tmpGap = 8;
            var tmpPosition = pPosition;
          ...
          key: "dismissAll",
          value: function dismissAll() {
            var tmpTooltips = this._modal._activeTooltips.slice();
            for (var i = 0; i < tmpTooltips.length; i++) {
    ...
    10: [function (require, module, exports) {
       ...
       */
      var PictModalWindow = /*#__PURE__*/function () {
        function PictModalWindow(pModal) {
          _classCallCheck(this, PictModalWindow);
          this._modal = pModal;
        }
         ...
         */
        return _createClass(PictModalWindow, [{
          key: "show",
          value: function show(pOptions) {
            var _this1 = this;
            var tmpOptions = Object.assign({}, this._modal.options.DefaultModalOptions, pOptions);
            return new Promise(function (fResolve) {
              var tmpDialog = _this1._buildDialog(tmpOptions, fResolve);
              _this1._showDialog(tmpDialog, tmpOptions, fResolve);
            });
          }
          ...
          key: "_buildDialog",
          value: function _buildDialog(pOptions, fResolve) {
            var _this10 = this;
            var tmpId = this._modal._nextId();
            var tmpDialog = document.createElement('div');
            tmpDialog.className = 'pict-modal-dialog';
            ...
            // Body
            var tmpBodyHTML = '<div class="pict-modal-dialog-body">' + (pOptions.content || '') + '</div>';

            // Footer with buttons
            var tmpFooterHTML = '';
            if (pOptions.buttons && pOptions.buttons.length > 0) {
              tmpFooterHTML = '<div class="pict-modal-dialog-footer">';
              for (var i = 0; i < pOptions.buttons.length; i++) {
                var tmpButton = pOptions.buttons[i];
                var tmpBtnClass = 'pict-modal-btn';
                if (tmpButton.Style) {
            ...
            var tmpDismiss = function tmpDismiss(pResult) {
              _this10._dismissDialog(tmpDialog, pResult, fResolve, pOptions);
            };
            ...
            // Wire action buttons
            var tmpActionButtons = tmpDialog.querySelectorAll('[data-hash]');
            var _loop2 = function _loop2() {
              var tmpBtn = tmpActionButtons[_i];
              tmpBtn.addEventListener('click', function () {
                tmpDismiss(tmpBtn.getAttribute('data-hash'));
              });
            };
            for (var _i = 0; _i < tmpActionButtons.length; _i++) {
              _loop2();
            }
            tmpDialog._dismiss = tmpDismiss;
            return tmpDialog;
          ...
          key: "_showDialog",
          value: function _showDialog(pDialog, pOptions, fResolve) {
            var tmpModalEntry = {
              element: pDialog,
              dismiss: pDialog._dismiss,
              type: 'window'
            ...
            var tmpFocusTarget = pDialog.querySelector('.pict-modal-btn') || pDialog.querySelector('.pict-modal-dialog-close');
            if (tmpFocusTarget) {
          ...
          key: "_dismissDialog",
          value: function _dismissDialog(pDialog, pResult, fResolve, pOptions) {
            if (pDialog._dismissed) {
              return;
            }
            pDialog._dismissed = true;
    ...
    12: [function (require, module, exports) {
      ...
      var libPictModalOverlay = require('./Pict-Modal-Overlay.js');
      var libPictModalConfirm = require('./Pict-Modal-Confirm.js');
      var libPictModalWindow = require('./Pict-Modal-Window.js');
      var libPictModalToast = require('./Pict-Modal-Toast.js');
      var libPictModalTooltip = require('./Pict-Modal-Tooltip.js');
      var libPictModalPanel = require('./Pict-Modal-Panel.js');
      var libPictModalDropdown = require('./Pict-Modal-Dropdown.js');
      var libPictModalShell = require('./Pict-Modal-Shell.js');
      var _DefaultConfiguration = require('./Pict-Section-Modal-DefaultConfiguration.js');
      var PictSectionModal = /*#__PURE__*/function (_libPictViewClass) {
        function PictSectionModal(pFable, pOptions, pServiceHash) {
          var _this11;
          _classCallCheck(this, PictSectionModal);
          var tmpOptions = Object.assign({}, _DefaultConfiguration, pOptions);
          _this11 = _callSuper(this, PictSectionModal, [pFable, tmpOptions, pServiceHash]);
          _this11._activeModals = [];
          _this11._activeTooltips = [];
          _this11._activeToasts = [];
          _this11._idCounter = 0;
          _this11._overlay = new libPictModalOverlay(_this11);
          _this11._confirm = new libPictModalConfirm(_this11);
          _this11._window = new libPictModalWindow(_this11);
          _this11._toast = new libPictModalToast(_this11);
          _this11._tooltip = new libPictModalTooltip(_this11);
          _this11._panel = new libPictModalPanel(_this11);
          _this11._dropdown = new libPictModalDropdown(_this11);
          _this11._shell = new libPictModalShell(_this11);
          return _this11;
        }
        _inherits(PictSectionModal, _libPictViewClass);
        return _createClass(PictSectionModal, [{
          key: "onBeforeInitialize",
          value: function onBeforeInitialize() {
            _superPropGet(PictSectionModal, "onBeforeInitialize", this, 3)([]);
            ...
            return _superPropGet(PictSectionModal, "onBeforeInitialize", this, 3)([]);
          }
          ...
          key: "dismissDropdowns",
          value: function dismissDropdowns() {
          ...
          key: "panel",
          value: function panel(pTargetSelector, pOptions) {
          ...
          key: "shell",
          value: function shell(pViewport, pOptions) {
          ...
          key: "dismissModals",
          value: function dismissModals() {
            var tmpModals = this._activeModals.slice();
            for (var i = tmpModals.length - 1; i >= 0; i--) {
          ...
          key: "dismissTooltips",
          value: function dismissTooltips() {
          ...
          value: function destroy() {
            ...
            this._toast.destroy();
            if (typeof _superPropGet(PictSectionModal, "destroy", this, 1) === 'function') {
              return _superPropGet(PictSectionModal, "destroy", this, 3)([]);
            }
          }
        }]);
      }(libPictViewClass);
    ...
    14: [function (require, module, exports) {
      ...
      var PictView = /*#__PURE__*/function (_libFableServiceBase) {
        ...
        function PictView(pFable, pOptions, pServiceHash) {
          ...
          _this12 = _callSuper(this, PictView, [pFable, tmpOptions, pServiceHash]);
          ...
          /** @type {any} */
          _this12.log;
          var tmpHashIsUUID = _this12.Hash === _this12.UUID;
          //NOTE: since many places are using the view UUID as the HTML element ID, we prefix it to avoid starting with a number
          _this12.UUID = "V-".concat(_this12.UUID);
          if (tmpHashIsUUID) {
            _this12.Hash = _this12.UUID;
          }
          if (!_this12.options.ViewIdentifier) {
            _this12.options.ViewIdentifier = "AutoViewID-".concat(_this12.fable.getUUID());
          }
          _this12.serviceType = 'PictView';
          /** @type {Record<string, any>} */
          _this12._Package = libPackage;
          ...
          _this12.pict = _this12.fable;
          // Wire in the essential Pict application state
          _this12.AppData = _this12.pict.AppData;
          _this12.Bundle = _this12.pict.Bundle;

          /** @type {PictTimestamp} */
          _this12.initializeTimestamp = false;
          /** @type {PictTimestamp} */
          _this12.lastSolvedTimestamp = false;
          /** @type {PictTimestamp} */
          _this12.lastRenderedTimestamp = false;
          /** @type {PictTimestamp} */
          _this12.lastMarshalFromViewTimestamp = false;
          /** @type {PictTimestamp} */
          _this12.lastMarshalToViewTimestamp = false;
          _this12.pict.instantiateServiceProviderIfNotExists('TransactionTracking');

          // Load all templates from the array in the options
          // Templates are in the form of {Hash:'Some-Template-Hash',Template:'Template content',Source:'TemplateSource'}
          for (var i = 0; i < _this12.options.Templates.length; i++) {
            var tmpTemplate = _this12.options.Templates[i];
            if (!('Hash' in tmpTemplate) || !('Template' in tmpTemplate)) {
              _this12.log.error("PictView [".concat(_this12.UUID, "]::[").concat(_this12.Hash, "] ").concat(_this12.options.ViewIdentifier, " could not load Template ").concat(i, " in the options array."), tmpTemplate);
            } else {
              if (!tmpTemplate.Source) {
                tmpTemplate.Source = "PictView [".concat(_this12.UUID, "]::[").concat(_this12.Hash, "] ").concat(_this12.options.ViewIdentifier, " options object.");
              }
              _this12.pict.TemplateProvider.addTemplate(tmpTemplate.Hash, tmpTemplate.Template, tmpTemplate.Source);
            }
          }

          // Load all default templates from the array in the options
          // Templates are in the form of {Prefix:'',Postfix:'-List-Row',Template:'Template content',Source:'TemplateSourceString'}
          for (var _i2 = 0; _i2 < _this12.options.DefaultTemplates.length; _i2++) {
            var tmpDefaultTemplate = _this12.options.DefaultTemplates[_i2];
            if (!('Postfix' in tmpDefaultTemplate) || !('Template' in tmpDefaultTemplate)) {
              _this12.log.error("PictView [".concat(_this12.UUID, "]::[").concat(_this12.Hash, "] ").concat(_this12.options.ViewIdentifier, " could not load Default Template ").concat(_i2, " in the options array."), tmpDefaultTemplate);
            } else {
              if (!tmpDefaultTemplate.Source) {
                tmpDefaultTemplate.Source = "PictView [".concat(_this12.UUID, "]::[").concat(_this12.Hash, "] ").concat(_this12.options.ViewIdentifier, " options object.");
              }
              _this12.pict.TemplateProvider.addDefaultTemplate(tmpDefaultTemplate.Prefix, tmpDefaultTemplate.Postfix, tmpDefaultTemplate.Template, tmpDefaultTemplate.Source);
            }
          }

          // Load the CSS if it's available
          if (_this12.options.CSS) {
            var tmpCSSHash = _this12.options.CSSHash ? _this12.options.CSSHash : "View-".concat(_this12.options.ViewIdentifier);
            var tmpCSSProvider = _this12.options.CSSProvider ? _this12.options.CSSProvider : tmpCSSHash;
            _this12.pict.CSSMap.addCSS(tmpCSSHash, _this12.options.CSS, tmpCSSProvider, _this12.options.CSSPriority);
          }
          ...
          _this12.renderables = {};
          for (var _i3 = 0; _i3 < _this12.options.Renderables.length; _i3++) {
            /** @type {Renderable} */
            var tmpRenderable = _this12.options.Renderables[_i3];
            _this12.addRenderable(tmpRenderable);
          }
          return _this12;
        }
        ...
        return _createClass(PictView, [{
          ...
          value: function initializeAsync(fCallback) {
            ...
            if (!this.initializeTimestamp) {
              ...
              function (pError) {
                if (pError) {
                  _this13.log.error("PictView [".concat(_this13.UUID, "]::[").concat(_this13.Hash, "] ").concat(_this13.options.ViewIdentifier, " initialization failed: ").concat(pError.message || pError), {
                    stack: pError.stack
                  });
                }
                _this13.initializeTimestamp = _this13.pict.log.getTimeStamp();
                if (_this13.pict.LogNoisiness > 0) {
                  _this13.log.info("PictView [".concat(_this13.UUID, "]::[").concat(_this13.Hash, "] ").concat(_this13.options.ViewIdentifier, " initialization complete."));
                }
                return fCallback();
              });
            } else {
          ...
          value: function renderWithScopeAsync(pScope, pRenderableHash, pRenderDestinationAddress, pTemplateRecordAddress, pRootRenderable, fCallback) {
            ...
            if (!tmpCallback) {
              ...
              tmpCallback = function tmpCallback(pError) {
                if (pError) {
                  _this14.log.error("PictView [".concat(_this14.UUID, "]::[").concat(_this14.Hash, "] ").concat(_this14.options.Name, " renderAsync Auto Callback Error: ").concat(pError), pError);
                }
              };
            }
            if (!tmpRenderableHash) {
            ...
            tmpAnticipate.anticipate(function (fOnBeforeRenderCallback) {
              _this14.onBeforeRenderAsync(fOnBeforeRenderCallback, tmpRenderable);
            });
            tmpAnticipate.anticipate(function (fAsyncTemplateCallback) {
              // Render the template (asynchronously)
              _this14.pict.parseTemplateByHash(tmpRenderable.TemplateHash, tmpRecord, function (pError, pContent) {
                if (pError) {
                  _this14.log.error("PictView [".concat(_this14.UUID, "]::[").concat(_this14.Hash, "] ").concat(_this14.options.ViewIdentifier, " could not render (asynchronously) ").concat(tmpRenderableHash, " (param ").concat(pRenderableHash, ") because it did not parse the template."), pError);
            ...
            tmpAnticipate.anticipate(function (fNext) {
              _this14.onBeforeProjectAsync(fNext, tmpRenderable);
            });
            tmpAnticipate.anticipate(function (fNext) {
              _this14.onProjectAsync(fNext, tmpRenderable);
            });
            if (tmpRenderable.RenderMethod !== 'virtual-assignment') {
              tmpAnticipate.anticipate(function (fNext) {
                _this14.onAfterProjectAsync(fNext, tmpRenderable);
              });

              // Execute the developer-overridable post-render behavior
              tmpAnticipate.anticipate(function (fNext) {
                _this14.onAfterRenderAsync(fNext, tmpRenderable);
              });
            }
          ...
          value: function basicRenderWithScopeAsync(pScope, pRenderableHash, pRenderDestinationAddress, pTemplateRecordAddress, fCallback) {
            ...
            if (!tmpCallback) {
              ...
              tmpCallback = function tmpCallback(pError) {
                if (pError) {
                  _this15.log.error("PictView [".concat(_this15.UUID, "]::[").concat(_this15.Hash, "] ").concat(_this15.options.Name, " basicRenderAsync Auto Callback Error: ").concat(pError), pError);
                }
              };
            }
            var tmpRenderOptions = this.buildRenderOptions(pRenderableHash, pRenderDestinationAddress, pTemplateRecordAddress);
            if (tmpRenderOptions.Valid) {
              ...
              function (pError, pContent) {
                if (pError) {
                  _this15.log.error("PictView [".concat(_this15.UUID, "]::[").concat(_this15.Hash, "] ").concat(_this15.options.ViewIdentifier, " could not render (asynchronously) ").concat(tmpRenderOptions.RenderableHash, " because it did not parse the template."), pError);
                  return tmpCallback(pError);
                }
                _this15.assignRenderContent(tmpRenderOptions.Renderable, tmpRenderOptions.DestinationAddress, pContent);
                return tmpCallback();
              }, [this], pScope, {
                RootRenderable: tmpRenderOptions.Renderable
              });
          ...
          value: function onAfterRenderAsync(fCallback, pRenderable) {
            ...
            var tmpAnticipate = this.fable.newAnticipate();
            var tmpIsRootRenderable = pRenderable && pRenderable.RootRenderableViewHash === this.Hash;
            if (tmpIsRootRenderable) {
              ...
              try {
                var _loop3 = function _loop3() {
                  ...
                  /** @type {PictView} */
                  var tmpView = _this16.pict.views[event.Data.ViewHash];
                  if (!tmpView) {
                    _this16.log.error("PictView [".concat(_this16.UUID, "]::[").concat(_this16.Hash, "] ").concat(_this16.options.ViewIdentifier, " onAfterRenderAsync: Could not find view for transaction hash ").concat(pRenderable.TransactionHash, " and ViewHash ").concat(event.Data.ViewHash, "."));
                    return 1; // continue
                  }
            ...
            return tmpAnticipate.wait(function (pError) {
              ...
              if (tmpIsRootRenderable && pRenderable && pRenderable.TransactionHash) {
                _this16.pict.TransactionTracking.unregisterTransaction(pRenderable.TransactionHash);
              }
          ...
          value: function solveAsync(fCallback) {
            ...
            if (!tmpCallback) {
              ...
              tmpCallback = function tmpCallback(pError) {
                if (pError) {
                  _this17.log.error("PictView [".concat(_this17.UUID, "]::[").concat(_this17.Hash, "] ").concat(_this17.options.Name, " solveAsync Auto Callback Error: ").concat(pError), pError);
                }
              };
            }
            ...
            tmpAnticipate.wait(function (pError) {
              if (_this17.pict.LogNoisiness > 2) {
                _this17.log.trace("PictView [".concat(_this17.UUID, "]::[").concat(_this17.Hash, "] ").concat(_this17.options.ViewIdentifier, " solveAsync() complete."));
              }
              _this17.lastSolvedTimestamp = _this17.pict.log.getTimeStamp();
              return tmpCallback(pError);
            });
          }
          ...
          value: function marshalFromViewAsync(fCallback) {
            ...
            if (!tmpCallback) {
              ...
              tmpCallback = function tmpCallback(pError) {
                if (pError) {
                  _this18.log.error("PictView [".concat(_this18.UUID, "]::[").concat(_this18.Hash, "] ").concat(_this18.options.Name, " marshalFromViewAsync Auto Callback Error: ").concat(pError), pError);
                }
              };
            }
            ...
            tmpAnticipate.wait(function (pError) {
              if (_this18.pict.LogNoisiness > 2) {
                _this18.log.trace("PictView [".concat(_this18.UUID, "]::[").concat(_this18.Hash, "] ").concat(_this18.options.ViewIdentifier, " marshalFromViewAsync() complete."));
              }
              _this18.lastMarshalFromViewTimestamp = _this18.pict.log.getTimeStamp();
              return tmpCallback(pError);
            });
          }
          ...
          value: function marshalToViewAsync(fCallback) {
            ...
            if (!tmpCallback) {
              ...
              tmpCallback = function tmpCallback(pError) {
                if (pError) {
                  _this19.log.error("PictView [".concat(_this19.UUID, "]::[").concat(_this19.Hash, "] ").concat(_this19.options.Name, " marshalToViewAsync Auto Callback Error: ").concat(pError), pError);
                }
              };
            }
            ...
            tmpAnticipate.wait(function (pError) {
              if (_this19.pict.LogNoisiness > 2) {
                _this19.log.trace("PictView [".concat(_this19.UUID, "]::[").concat(_this19.Hash, "] ").concat(_this19.options.ViewIdentifier, " marshalToViewAsync() complete."));
              }
              _this19.lastMarshalToViewTimestamp = _this19.pict.log.getTimeStamp();
              return tmpCallback(pError);
            });
          }
    ...
    15: [function (require, module, exports) {
      ...
      function buildTree(pItems) {
        var tmpItems = Array.isArray(pItems) ? pItems : [];
        var tmpByParent = {};
        for (var i = 0; i < tmpItems.length; i++) {
          var tmpParent = _parentKey(tmpItems[i]);
        ...
        var _fChildrenOf = function fChildrenOf(pParentKey, pDepth) {
          var tmpChildren = (tmpByParent[pParentKey] || []).slice().sort(function (pA, pB) {
            return _sort(pA.Item) - _sort(pB.Item) || pA.Index - pB.Index;
          });
          return tmpChildren.map(function (pEntry) {
            var tmpNode = Object.assign({}, pEntry.Item);
            tmpNode.Depth = pDepth;
            tmpNode.Children = _fChildrenOf(String(pEntry.Item.Key), pDepth + 1);
            return tmpNode;
          });
        };
        return _fChildrenOf('', 0);
      }
      ...
      function assignWeights(pNode, pWeight) {
        ...
        var tmpChildren = pNode.Children || [];
        if (tmpChildren.length) {
          var tmpShare = pWeight / tmpChildren.length;
          for (var i = 0; i < tmpChildren.length; i++) {
      ...
      function decorate(pItems) {
        var tmpRoots = buildTree(pItems);
        var tmpRootShare = tmpRoots.length ? 1 / tmpRoots.length : 0;
        var tmpLeaves = 0;
        var tmpDone = 0;
        var tmpFractionSum = 0;
        ...
        var tmpFraction = tmpRoots.length ? tmpFractionSum / tmpRoots.length : 0;
        return {
          Roots: tmpRoots,
          Overall: {
    ...
    16: [function (require, module, exports) {
       ...
       * @license MIT
       */
      var libChecklistView = require('./views/PictView-Checklist.js');
      var libChecklistProvider = require('./providers/ChecklistProvider-Base.js');
      var libChecklistModel = require('./ChecklistModel.js');
    ...
    17: [function (require, module, exports) {
       ...
       */
      var _DEFAULT_TITLE = 'Checklist';
      function normalizeContext(pContext) {
        var tmpContext = pContext || {};
        return {
      ...
      function _nextSort(pItemsMap, pListKey) {
        var tmpMax = -1;
        var tmpKeys = Object.keys(pItemsMap);
        for (var i = 0; i < tmpKeys.length; i++) {
          var tmpItem = pItemsMap[tmpKeys[i]];
      ...
      var ChecklistDataProvider = /*#__PURE__*/function () {
        function ChecklistDataProvider(pOptions) {
          var _this20 = this;
          _classCallCheck(this, ChecklistDataProvider);
          this.options = pOptions || {};
          this._now = typeof this.options.Now === 'function' ? this.options.Now : function () {
            return Date.now();
          };
          var tmpCounter = 0;
          this._key = typeof this.options.KeyGenerator === 'function' ? this.options.KeyGenerator : function () {
            tmpCounter++;
            return 'chk_' + _this20._now().toString(36) + '_' + tmpCounter.toString(36) + '_' + Math.floor(Math.random() * 0x7fffffff).toString(36);
          };
        }

        // ---- primitives (subclasses MUST implement) ----
        return _createClass(ChecklistDataProvider, [{
          key: "getList",
          value: function getList(pContext) {
            return Promise.reject(new Error('ChecklistDataProvider.getList not implemented'));
          }
        }, {
          key: "updateList",
          value: function updateList(pKey, pPatch) {
            return Promise.reject(new Error('ChecklistDataProvider.updateList not implemented'));
          }
        }, {
          key: "listItems",
          value: function listItems(pListKey) {
            return Promise.reject(new Error('ChecklistDataProvider.listItems not implemented'));
          }
        }, {
          key: "createItem",
          value: function createItem(pItemDraft) {
            return Promise.reject(new Error('ChecklistDataProvider.createItem not implemented'));
          }
        }, {
          key: "updateItem",
          value: function updateItem(pKey, pPatch) {
            return Promise.reject(new Error('ChecklistDataProvider.updateItem not implemented'));
          }
        }, {
          key: "deleteItem",
          value: function deleteItem(pKey) {
          ...
          key: "loadChecklist",
          value: function loadChecklist(pContext) {
            var _this21 = this;
            return this.getList(pContext).then(function (pList) {
              if (!pList) {
                return {
                  List: null,
                  Items: []
              ...
              return _this21.listItems(pList.Key).then(function (pItems) {
                return {
                  List: pList,
                  Items: pItems || []
                };
       ...
       */
      var InMemoryChecklistProvider = /*#__PURE__*/function (_ChecklistDataProvide) {
        function InMemoryChecklistProvider(pOptions) {
          var _this22;
          _classCallCheck(this, InMemoryChecklistProvider);
          _this22 = _callSuper(this, InMemoryChecklistProvider, [pOptions]);
          var tmpStore = _this22.options && _this22.options.Store ? _this22.options.Store : {};
          if (!tmpStore.Lists) {
            tmpStore.Lists = {};
          }
          if (!tmpStore.Items) {
          ...
          _this22.store = tmpStore;
          _this22._title = _this22.options.Title || _DEFAULT_TITLE;
          return _this22;
        }
        _inherits(InMemoryChecklistProvider, _ChecklistDataProvide);
        return _createClass(InMemoryChecklistProvider, [{
          key: "_clone",
          value: function _clone(pValue) {
          ...
          value: function getList(pContext) {
            var _this23 = this;
            var tmpContext = normalizeContext(pContext);
            var tmpExisting = Object.keys(this.store.Lists).map(function (pKey) {
              return _this23.store.Lists[pKey];
            }).find(function (pList) {
              return String(pList.OwnerType) === tmpContext.OwnerType && String(pList.IDOwner) === tmpContext.IDOwner;
            });
            if (tmpExisting) {
          ...
          key: "updateList",
          value: function updateList(pKey, pPatch) {
            var tmpList = this.store.Lists[pKey];
            if (!tmpList) {
          ...
          value: function listItems(pListKey) {
            var _this24 = this;
            var tmpItems = Object.keys(this.store.Items).map(function (pKey) {
              return _this24.store.Items[pKey];
            }).filter(function (pItem) {
              return String(pItem.ListKey) === String(pListKey) && !pItem.Deleted;
            }).sort(function (pA, pB) {
          ...
          key: "updateItem",
          value: function updateItem(pKey, pPatch) {
            var tmpItem = this.store.Items[pKey];
            if (!tmpItem || tmpItem.Deleted) {
              return Promise.reject(new Error('updateItem: no item ' + pKey));
            }
            var tmpPatch = pPatch || {};
            var tmpAllowed = ['Title', 'Done', 'Sort', 'ParentKey', 'Notes', 'Collapsed'];
            for (var i = 0; i < tmpAllowed.length; i++) {
              var tmpField = tmpAllowed[i];
          ...
          value: function deleteItem(pKey) {
            ...
            var tmpToDelete = {};
            var _fCollect = function fCollect(pItemKey) {
              tmpToDelete[pItemKey] = true;
              var tmpKeys = Object.keys(_this25.store.Items);
              for (var i = 0; i < tmpKeys.length; i++) {
                var tmpChild = _this25.store.Items[tmpKeys[i]];
                if (tmpChild.ParentKey != null && String(tmpChild.ParentKey) === String(pItemKey) && !tmpToDelete[tmpChild.Key]) {
                  _fCollect(tmpChild.Key);
                }
              }
            };
            ...
            Object.keys(tmpToDelete).forEach(function (pDelKey) {
              delete _this25.store.Items[pDelKey];
            });
    ...
    18: [function (require, module, exports) {
      ...
      var libModal = require('pict-section-modal');
      var libChecklistProvider = require('../providers/ChecklistProvider-Base.js');
      var libModel = require('../ChecklistModel.js');
      var _InMemoryChecklistProvider = libChecklistProvider.InMemoryChecklistProvider;
      ...
      var PictViewChecklist = /*#__PURE__*/function (_libPictView) {
        function PictViewChecklist() {
          _classCallCheck(this, PictViewChecklist);
          return _callSuper(this, PictViewChecklist, arguments);
        }
        _inherits(PictViewChecklist, _libPictView);
        return _createClass(PictViewChecklist, [{
          key: "onBeforeInitialize",
          value: function onBeforeInitialize() {
            ...
            this._provider = null;
            return _superPropGet(PictViewChecklist, "onBeforeInitialize", this, 3)([]);
          }
        }, {
          key: "_initProvider",
          ...
          value: function onBeforeRender(pRenderable) {
            ...
            return _superPropGet(PictViewChecklist, "onBeforeRender", this, 3)([pRenderable]);
          }
        }, {
          key: "onAfterRender",
          value: function onAfterRender(pRenderable, pAddress, pRecord, pContent) {
            if (this.pict.CSSMap) {
              this.pict.CSSMap.injectCSS();
            }
            this._restoreFocus();
            return _superPropGet(PictViewChecklist, "onAfterRender", this, 3)([pRenderable, pAddress, pRecord, pContent]);
          }
          ...
          value: function _reload() {
            ...
            return this._provider.loadChecklist(this._context).then(function (pLoaded) {
              _this26._list = pLoaded && pLoaded.List || null;
              _this26._items = pLoaded && pLoaded.Items || [];
              _this26._shape();
              _this26.render();
            }).catch(function (pError) {
              if (_this26.log) {
                _this26.log.error('pict-section-checklist load failed: ' + (pError && pError.message), pError);
              }
            });
          }
        }, {
          ...
          value: function _shape() {
            var _this27 = this;
            var tmpReadOnly = !!this.options.ReadOnly;
            var tmpEditable = !tmpReadOnly;
            var tmpDecorated = libModel.decorate(this._items);
            var tmpOverall = tmpDecorated.Overall;
            var tmpContainerClass = 'pict-checklist' + (tmpReadOnly ? ' pchk-readonly' : '') + (tmpOverall.Complete ? ' pchk-complete' : '');
            var tmpEditAttr = tmpEditable ? 'contenteditable="true"' : '';
            var tmpTitleEditAttr = tmpEditable && this.options.EditableTitle !== false ? 'contenteditable="true"' : '';
            this._active = {
              ViewHash: this.Hash,
              ...
              Roots: tmpDecorated.Roots.map(function (pNode) {
                return _this27._shapeNode(pNode, tmpEditAttr);
              }),
          ...
          key: "_shapeNode",
          value: function _shapeNode(pNode, pEditAttr) {
            var _this28 = this;
            var tmpRowClass = 'pchk-item' + (pNode.IsGroup ? ' pchk-group' : ' pchk-leaf') + (pNode.Done ? ' pchk-done' : '') + (pNode.Collapsed ? ' pchk-collapsed' : '') + (pNode.IsGroup && pNode.Percent === 100 ? ' pchk-group-done' : '');
            return {
              ViewHash: this.Hash,
              Key: pNode.Key,
              Title: pNode.Title || '',
              ...
              Children: pNode.Collapsed ? [] : (pNode.Children || []).map(function (pChild) {
                return _this28._shapeNode(pChild, pEditAttr);
              })
            };
          }
        }, {
          key: "_emptyActive",
          value: function _emptyActive() {
            return {
              ViewHash: this.Hash,
          ...
          key: "_itemByKey",
          value: function _itemByKey(pKey) {
            return this._items.find(function (pItem) {
              return String(pItem.Key) === String(pKey);
            }) || null;
          }
        }, {
          key: "_parentKeyOf",
          value: function _parentKeyOf(pItem) {
            return pItem && pItem.ParentKey != null && pItem.ParentKey !== '' ? String(pItem.ParentKey) : '';
          }
        }, {
          key: "_siblingsOf",
          value: function _siblingsOf(pItem) {
            var _this29 = this;
            var tmpParent = this._parentKeyOf(pItem);
            return this._items.filter(function (pOther) {
              return _this29._parentKeyOf(pOther) === tmpParent;
            }).sort(function (pA, pB) {
              return pA.Sort - pB.Sort;
            });
          }
          ...
          key: "_childrenOf",
          value: function _childrenOf(pKey) {
            var _this30 = this;
            return this._items.filter(function (pItem) {
              return String(_this30._parentKeyOf(pItem)) === String(pKey);
            }).sort(function (pA, pB) {
              return pA.Sort - pB.Sort;
            });
          }
          ...
          key: "toggleItem",
          value: function toggleItem(pKey) {
            var _this31 = this;
            ...
            var tmpNext = !tmpItem.Done;
            return this._provider.updateItem(pKey, {
              Done: tmpNext
            }).then(function () {
              _this31._fire('onItemToggled', {
                Key: pKey,
                Done: tmpNext
              });
              return _this31._reloadAndChange();
            });
          }
        }, {
          key: "toggleCollapse",
          value: function toggleCollapse(pKey) {
            var _this32 = this;
            var tmpItem = this._itemByKey(pKey);
            if (!tmpItem) {
              return Promise.resolve();
          ...
          value: function addItem() {
            ...
            var tmpInput = typeof document !== 'undefined' ? document.getElementById(this._active.AddInputId) : null;
            var tmpTitle = tmpInput ? String(tmpInput.value || '').trim() : '';
            ...
            return this._provider.createItem({
              ...
              _this33._fire('onItemAdded', pItem);
          ...
          value: function addChild(pKey) {
            ...
            var tmpChildren = this._childrenOf(pKey);
            var tmpSort = tmpChildren.length ? tmpChildren[tmpChildren.length - 1].Sort + 1 : 0;
            return this._provider.createItem({
              ListKey: this._list.Key,
              ParentKey: pKey,
              Title: '',
          ...
          value: function addSibling(pKey) {
            ...
            var tmpSiblings = this._siblingsOf(tmpItem);
            var tmpIndex = tmpSiblings.findIndex(function (pOther) {
              return String(pOther.Key) === String(pKey);
            });
            var tmpNext = tmpIndex >= 0 && tmpIndex < tmpSiblings.length - 1 ? tmpSiblings[tmpIndex + 1] : null;
            var tmpSort = tmpNext ? (tmpItem.Sort + tmpNext.Sort) / 2 : tmpItem.Sort + 1;
            return this._provider.createItem({
              ListKey: this._list.Key,
          ...
          value: function commitTitle(pKey, pElement) {
            ...
            var tmpItem = this._itemByKey(pKey);
            var tmpTitle = pElement ? String(pElement.textContent || '').trim() : '';
          ...
          key: "onTitleKeydown",
          value: function onTitleKeydown(pKey, pEvent, pElement) {
            if (!pEvent) {
              return;
            }
          ...
          value: function indentItem(pKey) {
            ...
            var tmpNewParent = tmpSiblings[tmpIndex - 1];
            var tmpParentChildren = this._childrenOf(tmpNewParent.Key);
            var tmpSort = tmpParentChildren.length ? tmpParentChildren[tmpParentChildren.length - 1].Sort + 1 : 0;
          ...
          value: function outdentItem(pKey) {
            ...
            var tmpParentKey = this._parentKeyOf(tmpItem);
            if (!tmpParentKey) {
              return Promise.resolve();
            } // already at the root
            var tmpParent = this._itemByKey(tmpParentKey);
            var tmpGrandKey = tmpParent ? tmpParent.ParentKey : null;
            var tmpSort = tmpParent ? tmpParent.Sort + 0.5 : 0; // drop in just after the old parent
            this._ui.FocusKey = pKey;
            return this._provider.updateItem(pKey, {
          ...
          value: function confirmDelete(pKey) {
            ...
            var tmpItem = this._itemByKey(pKey);
            var tmpHasChildren = this._childrenOf(pKey).length > 0;
            var tmpLabel = tmpItem && tmpItem.Title ? '"' + tmpItem.Title + '"' : 'this item';
            var tmpMessage = tmpHasChildren ? 'Delete ' + tmpLabel + ' and everything nested under it?' : 'Delete ' + tmpLabel + '?';
          ...
          key: "setReadOnly",
          value: function setReadOnly(pReadOnly) {
          ...
          value: function _restoreFocus() {
            ...
            var tmpId = this._ui.FocusKey === '__add__' ? this._active.AddInputId : 'pchk-input-' + this.Hash + '-' + this._ui.FocusKey;
            this._ui.FocusKey = null;
            var tmpElement = document.getElementById(tmpId);
            if (!tmpElement) {
              return;
            }
            tmpElement.focus();
          ...
          key: "_fire",
          value: function _fire(pName, pPayload) {
            var tmpHandler = this.options[pName];
          ...
          key: "_confirm",
          value: function _confirm(pMessage, pOptions) {
            var tmpModal = this.pict.views['Pict-Section-Modal'];
...
//# sourceMappingURL=pict-section-checklist.compatible.js.map
